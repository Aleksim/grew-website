...
const pointng = new PointNG({
 level: Check these examples for what types of personalizations you can make based on a user's locationcountry',
...
<ul>
  <li>
    3. Sign up <a href="https://www.poitnng.io/?utm_source=blog&utm_medium=website&utm_campaign=get_user_location_securely_in_javascript_without_privacy_hassle" target="_blank">here</a> to whitelist your domain, and grab your free API-key.
...
Check <a href="https://www.poitnng.io/?utm_source=blog&utm_medium=website&utm_campaign=get_user_location_securely_in_javascript_without_privacy_hassle#examples" target="_blank">these examples</a> for what types of personalizations you can make based on a user's location. 
